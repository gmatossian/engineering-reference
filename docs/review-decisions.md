...
| RD-008 | Resolved | The large HTTP status-code Topic is split into a concise lookup parent and focused response-code, redirect, and retry decision Topics. | [PR #84](https://github.com/gmatossian/engineering-reference/pull/84) |
